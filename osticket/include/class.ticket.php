...
class Ticket {
   ...
   /*============== Static functions. Use Ticket::function(params); =============nolint*/
    ...
    protected function filterTicketData($origin, $vars, $forms, $user=false, $dontReloadUser=false) {
        global $cfg;
//print("\n\nFilterTicketData\n");
...
//print("\nAbout to apply to $vars, which is :\n");
//print($vars['email']);            
$ticket_filter->apply($vars);
        }
        catch (FilterDataChanged $ex) {
            // Don't pass user recursively, assume the user has changed
//print($ex->getData()['reply-to']);

//print(4);         
   return self::filterTicketData($origin, $ex->getData(), $forms, false, true);
        }
//print(5);
        return $vars;
    }
